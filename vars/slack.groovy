                ...
                "attachments": [
                    {
                        ...
                        "title": "Build No: ${currentBuild.number} - ${currentBuild.displayName}",
                        "title_link": "${currentBuild.absoluteUrl}",
                        "text": "ufff... :green_heart: Previous(#${currentBuild.previousBuild.number}) - ${currentBuild.previousBuild.displayName} build got fixed now :green_heart:"
                    }
                ]
            }'
